export default function handler(req, res) {
    res.status(200).json({
        "banner": {
            "maintitle": "Business Work",
            "title": "Engagement model",
            "subtitle": "Unlock your business potentials with our novel and customizable engagement models",
            "button": {
                "url": "#",
                "title": "Get Started",
                "target": ""
